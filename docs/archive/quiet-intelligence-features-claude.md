...
- [Competitive Growth Plan](competitive-growth-plan-claude.md) — Original AI strategy discussion
- [Strategic Viability Review](strategic-viability-review-claude.md) — Competitive positioning
- [Monetization Philosophy](monetization-philosophy.md) — Pricing approach
- [PRD](prd.md) — Product requirements
- [E2EE Implementation Plan v1.4](e2ee-implementation-plan.md) — Encryption plan that affects processing architecture
