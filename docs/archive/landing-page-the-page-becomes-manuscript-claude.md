...
- [Landing Page Backlog](landing-page-backlog.md) — Living tracker, gaps and rejected ideas
- [Impeccable Design Critique 2026-03-28](impeccable-design-critique-2026-03-28-claude.md) — Post-PR-#183 critique whose P1 (manuscript steals CTA focus) this proposal eliminates structurally
- [Landing Page Award-Winning Redesign](landing-page-award-winning-redesign-claude.md) — Prior plan whose checklist this proposal supersedes
- [Implementation Spec — Landing Page Redesign (PR #183)](landing-page-redesign-implementation-spec-codex.md) — Spec for the previous, two-column redesign
