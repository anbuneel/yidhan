...
**Design Doc:** [`docs/analysis/e2ee-sharing-design-claude.md`](e2ee-sharing-design-claude.md)
**Peer Review:** [`docs/reviews/plan-review-b7d4e91f.md`](plan-review-b7d4e91f.md) — 2 rounds, 7 findings, APPROVED
...
See the [design doc](e2ee-sharing-design-claude.md) for the full architecture, cryptographic envelope spec, security hardening details, and the Codex review decisions log.
