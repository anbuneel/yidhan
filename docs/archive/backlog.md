...
|------|----------|--------|
| [Landing Page Backlog](landing-page-backlog.md) | Mixed | 4 analysis docs + design critique |
...
| Item | Priority | Source |
|------|----------|--------|
| Trust badges visibility — proof rail may be too subtle | P2 | [Design critique 03-28](impeccable-design-critique-2026-03-28-claude.md) |
| Demo Practice Space — needs 3-4 starter notes (not just 1 welcome card) | P4 | [Design critique 03-28](impeccable-design-critique-2026-03-28-claude.md) |
| Earlier design critique open items | Various | [Design critique tracker](design-critique-tracker.md) |
...
| Item | Priority | Source |
|------|----------|--------|
| Editor calm & delight — 9 changes (sidebar toolbar, metadata, writing surface) | P2 | [Editor calm & delight plan](2026-03-09-editor-calm-delight.md) |
...
| Item | Priority | Source |
|------|----------|--------|
| iOS Capacitor setup (requires macOS) | P3 | [Mobile iOS overhaul plan](mobile-ios-overhaul-plan.md) |
| iOS PWA experience checklist | P3 | [iOS PWA checklist](ios-pwa-experience-checklist-codex.md) |
...
| Item | Priority | Source |
|------|----------|--------|
| Quiet Tasks — surface buried tasks/intentions | P3 | [Quiet Tasks plan](quiet-tasks-implementation-plan.md) |
| Quiet Intelligence — reflective AI features | Deferred | [Quiet Intelligence analysis](quiet-intelligence-features-claude.md) |
| Subscription & feature gating (Bloom tier) | Deferred | [Subscription architecture](subscription-architecture-claude.md) |
...
| Item | Priority | Source |
|------|----------|--------|
| Reliability hardening items 4-5 (note-tag convergence, search/sync scale) | Post-launch | [Reliability plan](reliability-hardening-plan-codex.md) |
