...
createRoot(document.getElementById('root')!).render(<><ChapteredLibrary notes={notes} onNoteClick={() => {}} onNoteDelete={() => false} onTogglePin={() => {}} /><footer className="p-8 text-center">End of practice library</footer></>);
